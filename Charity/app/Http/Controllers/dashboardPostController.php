...
class dashboardPostController extends Controller
{
    ...
    **/
    ...
    {
        // GET Posts
        $Posts = Post::with('Category')->with('ia')->with('www')->with('User')->simplePaginate(10);
    ...
    public function create()
    {
        ...
        $ia = ia::all();
        $www = www::all();
        return view('dashboard.dashboardPosts.create',compact('Users','Categores','ia','www'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $Post->ia_id = $request->input('ia_id');
        $Post->www_id = $request->input('www_id');
    ...
    public function edit($slug)
    {
        ...
        $ias = ia::all();
        $wwws = www::all();
        return view('dashboard.dashboardPosts.edit',compact('Post','Users','Categores','ias','wwws'));
    }
