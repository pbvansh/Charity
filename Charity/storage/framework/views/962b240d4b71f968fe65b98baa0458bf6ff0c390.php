...
<body class="h-100">      
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="main-navbar">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('dashboard/dashboardia')); ?>">
                  <i class="icon-feather-archive"></i>
                  <span>Inovation Area</span>
                </a>
              </li>
                <!-- ============================================= nav admin Site ============================================= -->
                <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('dashboard/dashboardwww')); ?>">
                  <i class="icon-feather-archive"></i>
      ...
      </html><?php /**PATH E:\xamp\htdocs\Charity\Charity\resources\views/dashboard/layouts/postmain.blade.php ENDPATH**/ ?>