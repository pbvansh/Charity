  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class="icon-line-awesome-align-justify"></i> Where We Work 
          <a href="<?php echo e(route('dashboardwww.create')); ?>" class="mb-2 btn btn-success mr-2"><i class="icon-material-outline-add-circle-outline"></i> 
          Add Work Location</a>
        </h3>  
        </div>
      </div>
        ...
        <div class="col-lg-12 mb-4">
          <div class="card card-small lo-stats h-100">
            <div class="card-header border-bottom">
              <h6 class="m-0"> Location where we workss</h6>
            ...
            <a href="<?php echo e(URL::to('dashboard/dashboardwww')); ?>/<?php echo e($Category->slug); ?>/edit" class="mb-2 btn btn-sm btn-primary">
            <i class="icon-feather-edit"></i> Edit</a>
           <!-- ================================ dashboard Categores store ====================================== -->
           <form action="<?php echo e(route('dashboardwww.destroy',$Category->id)); ?>" method="POST" files="true" style="display: inline-block;">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\Charity\Charity\resources\views/dashboard/dashboardwww/index.blade.php ENDPATH**/ ?>