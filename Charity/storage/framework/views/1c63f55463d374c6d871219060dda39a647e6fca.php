...
<div>
			 <select class="custom-select" name="www_id">
                <option value="1" selected="">Where We Work</option>
                <?php $__currentLoopData = $www; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $www): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <select class="custom-select" name="ia_id" >
                <option value="1" selected="">Inovaion Area</option>
                <?php $__currentLoopData = $ia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($ia->id); ?>"><?php echo e($ia->title); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</select>
</div>
	<div  style="margin-left:30px"> 
		<button class="btn btn-sm btn-accent ml-auto " onclick>
			<i class="icon-feather-file-plus"></i> Find Posts
		</button>
	</div>
</div>
<!--================Blog Area =================-->
...
<?php echo $__env->make('english.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xamp\htdocs\Charity\Charity\resources\views/english/Posts/index.blade.php ENDPATH**/ ?>