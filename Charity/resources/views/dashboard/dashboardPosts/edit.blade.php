      ...
      <div class="col-lg-9 col-md-12">
        ...
        <div class="card card-small mb-3">
          <div class="card-body">
              ...
              @if(isset($Post->ia->title))
                 <option  value="{{ $Post->ia_id }}" selected="">{{ $Post->ia->title }}</option>
                 @else
            ...
            <div class="form-control form-control-lg mb-3">
              ...
              @if(isset($Post->www->title))
                 <option  value="{{ $Post->category_id }}" selected="">{{ $Post->www->title }}</option>
                 @else
