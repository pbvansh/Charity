    ...
    <div class="row">
      <div class="col-lg-9 col-md-12">
        ...
        <div class="card card-small mb-3">
          <div class="card-body">
            <form class="add-new-post" action="{{ route('dashboardwww.update',$www->slug) }}" method="POST"  role="form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
              <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Category Order" name="order" value="{{ $www->order }}">
              <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Category Title" name="title" value="{{ $www->title }}">
              <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Category Slug" name="slug" value="{{ $www->slug }}">
              <select class="custom-select" name="color">
                <option value="{{ $www->color }}" selected="">{{ $www->color }}</option>
          ...
          <div class='card-body p-0'>
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex px-3">
                   <a href="{{ url('dashboard/dashboardwww') }}" class="btn btn-sm btn-outline-accent"><i class="icon-line-awesome-align-justify"></i> Where We Work</a>
