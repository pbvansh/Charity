    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class="icon-line-awesome-align-justify"></i> Where We Work 
          <a href="{{ route('dashboardwww.create') }}" class="mb-2 btn btn-success mr-2"><i class="icon-material-outline-add-circle-outline"></i> 
          Add Work Location</a>
        </h3>  
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12 mb-4">
          <div class="card card-small lo-stats h-100">
            ...
            <a href="{{ URL::to('dashboard/dashboardwww')}}/{{$Category->slug}}/edit" class="mb-2 btn btn-sm btn-primary">
            <i class="icon-feather-edit"></i> Edit</a>
           <!-- ================================ dashboard Categores store ====================================== -->
           <form action="{{ route('dashboardwww.destroy',$Category->id) }}" method="POST" files="true" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
